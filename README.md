...
An additional option **Enable autoupdate** can pull the latest changes via `git pull` and reload the module automatically. Autoupdates run once per day at **04:00** local time.
