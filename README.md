...
An additional option **Enable autoupdate** can pull the latest changes via `git pull` and reload the module automatically. When enabled, the module checks for updates on startup and again each day at 04:00 local time.
